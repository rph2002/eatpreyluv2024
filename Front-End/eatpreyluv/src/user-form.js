  ...
  const handleClick = async (e) => {
    ...
    if (!finalValidation) {
      ...
      try {
        ...
        await axios.post(`http://localhost:8080/customers/add`, user);
        const result = await axios.get(
          `http://localhost:8080/customers/getUser/${user.email}`
        );
        const localUser = result.data;
  ...
  return (
    <form id="CreateAccForm">
      <div className="form-group">
        ...
        />
        {fNameValidation && <div className="error-msg">{fNameValidation}</div>}
      </div>
      ...
      <div className="form-group">
        ...
        />
        {lNameValidation && <div className="error-msg">{lNameValidation}</div>}
      </div>
      ...
      <div className="form-group">
        ...
        />
        {emailValidation && <div className="error-msg">{emailValidation}</div>}
      </div>
      ...
      <div className="form-group">
        ...
        />
        {phoneValidation && <div className="error-msg">{phoneValidation}</div>}
      </div>
